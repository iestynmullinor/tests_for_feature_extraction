...
public class App {
    ...
    public static void main(String[] args) {
        ...
        double[][] raw_data = new double[][] {{-0.49682617, -0.8357544, 0.34490967},
        ...
        {-0.3544922, -0.8328247, 0.025817871},
        ...
        {-0.48046875, -0.8340454, 0.050720215},
        ...
        List<Float[]> data_as_list = convertDoubleArrayToArrayList(raw_data);

        List<Float[]> features = FeatureExtraction.extract_features(data_as_list);
